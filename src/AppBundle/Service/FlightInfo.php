...
class FlightInfo
{
     ...
     * @param int $time Defined in config.yml
     */
    public function __construct($unit,$time){
        $this->unit = $unit ;
        $this->time = $time;
    }
     ...
     * http://www.codecodex.com/wiki/Calculate_Distance_Between_Two_Points_on_a_Globe#PHP
     *
     * @param smallint $cruiseSpeed  PlaneModel
     *
     * @return int
     */

    public function getTime($distance=null ,$cruiseSpeed){
       // T =d/v;
